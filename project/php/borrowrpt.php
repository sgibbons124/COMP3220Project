...
<?php
  ...
  $query  = "SELECT first_name, count(first_name) as cnt FROM borrow, member WHERE borrow.member_id=member.member_id GROUP BY first_name";
...
?>               
        ...
        var options = {title: 'Percentage of Borrowing by Person'};
