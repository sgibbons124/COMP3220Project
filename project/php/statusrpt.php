...
<?php 
  ...
  $query  = "SELECT book.isbn, author, title, category, book_status from book, book_detail WHERE book.isbn=book_detail.isbn ORDER BY book_status";
  $result = $conn->query($query);
  if (!$result) die ("Database access failed: " . $conn->error);

  echo'<p1>Book Status Report</p1>';
